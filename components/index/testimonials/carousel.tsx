...
import SmilingGirl from '../../../public/assets/images/testimonials/smilingGirl.png';
import computerBoy from '../../../public/assets/images/testimonials/computerBoy.png';
import girlInRed from '../../../public/assets/images/testimonials/girlInRed.png';
import Underline from '../../../public/assets/images/testimonials/carouselUnderline.svg';
import Circle from '../../../public/assets/images/testimonials/circle.svg';
import TailorGirlLarge from '../../../public/assets/images/testimonials/carouselImg1.png';
import Ali from '../../../public/assets/images/testimonials/alim.jpg';
...
function Item({
  ...
  return (
    <div className={styles.carouselItemContainer}>
      ...
      >
        <Image src={item.image} alt="customer's image" />
      </div>
...
export default function Carousell() {
  ...
  var items = [
    ...
    },
    {
      ...
      description:
        'My business started out very small, but when i applied and got the loan from The Business Hub, it helped my business grow tremendously. From producing blocks out of 50 bags of cement weekly, I now produce blocks with a trailer of cements weekly.',
      image: largeDesktop ? Ali : SmilingGirl,
      summary: '“Extraordinary Services”',
      whoAreYou:
        '— Mrs. Adebimpe Agboola, MD, Divine Integrated Blocks Service.',
    },
